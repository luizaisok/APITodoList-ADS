...
app.post("/tarefa", async (req, res) => {
    ...
    const result = await insertTarefa(id, titulo, descricao, data_vencimento, status);
...
/*
    app.delete("/tarefa/:id", (req, res) => {
        ...
        if(result){
            return res.send("Tarefa removida com sucesso!");
        }
        return res.send("Não foi possível remover a tarefa");
    });
*/
